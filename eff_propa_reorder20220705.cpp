...
//..............reading flags from user input...end..................//
    ...
    ofstream conv(out_dir + "1e7Hy_conversion.out");
    ofstream molwt(out_dir+"1e7Hy_molecularweight.out");
    ofstream fract(out_dir+"1e7Hy_fractions.out");
    ofstream speciesout(out_dir+"1e7Hy_species.out");
    ofstream species_con(out_dir+"1e7Hy_spe_con.out");

    ofstream ads_dis(out_dir+"1e7Hy_ads_distribution.out");
    ofstream triad_dis(out_dir+"1e7Hy_triad_distribution.out");
    ofstream eq_dyad(out_dir+"1e7Hy_equal_dyad_point.out");
...
//        if (scale_fac==0) scale_fac=1;
    ...
    cout<<"average scaling_factor= "<< (all_scale_fac/time) <<endl;
    cout<<"runnning time = "<<(double)(end-start)/CLOCKS_PER_SEC<<"s"<<endl;
    return 0;
}
