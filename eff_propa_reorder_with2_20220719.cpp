...
int main( ) {
    clock_t start,end;
    start=clock();
    std::string data_dir = "/Users/yueyue/Desktop/effPropaRecorder0330/src/";
    std::string out_dir = "/Users/yueyue/Desktop/effPropaRecorder0330/output/";
    ...
    double total_rate = 0.0, reaction = 0.0, time = 0.0, init_vol = 0.0, D_time = 0.0,d_time = 0.0;
...
//..............reading flags from user input...end..................//
    ...
    ofstream conv(out_dir + "1e8Hy_conversion.out");
    ofstream molwt(out_dir+"1e8Hy_molecularweight.out");
    ofstream fract(out_dir+"1e8Hy_fractions.out");
    ofstream speciesout(out_dir+"1e8Hy_species.out");
    ofstream species_con(out_dir+"1e8Hy_spe_con.out");
    ofstream tim(out_dir+"1e8Hy_time.out");

    ofstream ads_dis(out_dir+"1e8Hy_ads_distribution.out");
    ofstream triad_dis(out_dir+"1e8Hy_triad_distribution.out");
    ofstream eq_dyad(out_dir+"1e8Hy_equal_dyad_point.out");
...
//    sol_mf = solvent_conc/(init_conc+solvent_conc)*(1 - mf_monom);
//    init_vol += sol_mf * M0 / (solvent_conc * Na);
//    cout<<sol_mf<<endl;
//    species[11] = round(M0 *sol_mf );
//
//    sol_mf=1 - mf_monom - sol_mf;
//    init_vol += sol_mf * M0 / (init_conc * Na);
//    cout<<sol_mf<<endl;
//    species[0] = round(M0 *sol_mf );
...
//    ode(stiff_sys, system_jacobi,r,0.16);
...
//if (over_x>conv_in) break;
        ...
        if (D_time >= 500.0) {
            ...
            scale_fac=(add_spe3/d_time/(Na*volume))/radical_ode;
