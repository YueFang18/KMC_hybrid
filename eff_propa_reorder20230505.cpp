...
int main( ) {
    ...
    std::string data_dir = "/Users/yueyue/Dropbox/Mac/Documents/HKUST/GAO_project/P1_KMC_Acceleration_Scaling/code/effATRP_new/src/";
    std::string out_dir = "/Users/yueyue/Dropbox/Mac/Documents/HKUST/GAO_project/P1_KMC_Acceleration_Scaling/code/effATRP_new/output/";
...
//............. Assigning Input  data to the varibles from input.txt, Ends ......//
    ...
    molwt << "time" << "\t" <<"conversion"<< "\t" << "Mn" << "\t" << "\t" << "Mw" << "\t" << "\t" << "pdi" << "\t" << "\t" << "Dpn"
          << endl;
...
//        if (d_time_1 > 0.005 && flag0 == 0 && pre_add_spe2!=0){
//
////ODE
...
//            d_time_1 = 0.0;
//            flag0 = 1;
//            sf<<"scale_fac=   "<<scale_fac<<"  "<<scale_fac_s2<<"    "<<s3<<endl;
//            cout<<"000         000"<<endl;
//        }
//
//
