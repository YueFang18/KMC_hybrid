...
//..............reading flags from user input...end..................//
    ...
    ofstream conv(out_dir + "1.39_1e9KMC_conversion.out");
    ofstream molwt(out_dir+"1.39_1e9KMC_molecularweight.out");
    ofstream fract(out_dir+"1.39_1e9KMC_fractions.out");
    ofstream speciesout(out_dir+"1.39_1e9KMC_species.out");
    ofstream species_con(out_dir+"1.39_1e9KMC_spe_con.out");

    ofstream ads_dis(out_dir+"1.39_1e9KMC_ads_distribution.out");
    ofstream triad_dis(out_dir+"1.39_1e9KMC_triad_distribution.out");
    ofstream eq_dyad(out_dir+"1.39_1e9KMC_equal_dyad_point.out");
