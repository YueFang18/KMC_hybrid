...
int main( ) {
    ...
    double total_rate = 0.0, reaction = 0.0, time = 0.0, init_vol = 0.0, D_time = 0.0,d_time = 0.0,d_time_1 = 0.0,pre_d_time2 = 0.0;
    ...
    double radical_ode = 0.0, radical_kmc = 0.0,pre_add_spe2=0.0;
    double x[11]={0.0};
...
//calculate the SF at beginning with 2
        ...
        if (d_time>0.1 && pre_add_spe2!=0 && fl_aver==0){
            ...
            sf<<"   "<<aver_spe3<<"   "<<pre_add_spe2<<"  "<<all_species<<" "<<tau<<"   "<<pre_d_time2<<"   "<<scale_fac <<"   "<<radical_ode<<"    "<<"222   222"<<endl;
