...
//..............reading flags from user input...end..................//
    ...
    ofstream m1m1(out_dir+"1e8Hy_M1M1.out");
    ofstream polyinfo(out_dir+"1e8Hy_polychain.out");
    ofstream polyinfomw(out_dir+"1e8Hy_polychain_mw.out");
    ofstream aver(out_dir + "1e8Hy_aver_spe3.out");
    ...
    ofstream sequence(out_dir + "1e8Hy_cianinfo.out");
    ccd_count1 << "\t" << "ccd" << endl;
